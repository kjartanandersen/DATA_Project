...
###
# Þessi kóði sækir gögnin CIFAR-10 og augmentar þau býr til training og test set
###
...
if __name__ == "__main__":
    ...
    training_set = torchvision.datasets.CIFAR10(root='./data', train=True,download=True, transform=data_augment)
    ...
    testing_set = torchvision.datasets.CIFAR10(root='./data', train=False,download=True, transform=data_augment)
